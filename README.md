...
- its an open source alternative for firebase. its used to manage the backend for react-native apps.
- it has postgreSQL build in to provide authentication, real-timedatabase storage and more.
- create an account and a project to start.
...
- we then create a superbase client inside a folder named lib in the root direcory ,.... inside it create a file name superbase.js
- next we create a login component
